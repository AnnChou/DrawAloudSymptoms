...
// Update brush color from custom color picker
const colorPicker = document.getElementById('brushColor');
if (colorPicker) {
  canvas.freeDrawingBrush.color = colorPicker.value; // initialize brush color
  colorPicker.addEventListener('change', () => {
    canvas.freeDrawingBrush.color = colorPicker.value;
  });
}

// Update brush color from preset color buttons
document.querySelectorAll('.brushColorBtn').forEach(btn => {
